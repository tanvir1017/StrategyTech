        ...
        <Row className='g-0 px-3 pb-5'>
            ...
            <Col md={5} sm={12} lg={5}>
                <ul>
                    ...
                    <li className='mb-2 fs-6 '>178 West 27th Street, Suite 527 New York NY 10012</li>
                    <li className='mb-2 fs-6 '>+00965652653</li>
                    <li className='mb-2 fs-6 '>career@strategy.com</li>
                    <li>
                        <ul className='d-flex p-0'>
                            <li className='me-4 fs-4 mt-3'><i class="fab fa-linkedin-in"></i></li>
                            <li className='me-4 fs-4 mt-3'><i class="fab fa-twitter"></i></li>
                            <li className='me-4 fs-4 mt-3'><i class="fab fa-facebook-f"></i></li>
                            <li className='me-4 fs-4 mt-3'><i class="fab fa-snapchat-ghost"></i></li>
                        </ul>
                    </li>
                </ul>
            </Col>
